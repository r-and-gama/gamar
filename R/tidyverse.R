...
#' @name tidyverse
anti_join.experiment <- function(x, y, ...) { # nocov start
...
#' @param ... other arguments
#' @name tidyverse
arrange.experiment <- function(.data, ...) { # nocov start
...
#' @param ... other arguments
#' @name tidyverse
distinct.experiment <- function(.data, ...) {  # nocov start
	old_attr <- purrr::keep(attributes(.data), names(attributes(.data)) %in% c("dic_r2g", "dic_g2r", "experiment", "model", "class"))
 	.data <- as.data.frame(.data)
...
#' @param ... other arguments
#' @name tidyverse
filter_.experiment <- function(.data, ...) {  # nocov start
	old_attr <- purrr::keep(attributes(.data), names(attributes(.data)) %in% c("dic_r2g", "dic_g2r", "experiment", "model", "class"))
 	.data <- as.data.frame(.data)
...
#' @param ... other arguments
#' @name tidyverse
inner_join.experiment <- function(x, y, ...) {  # nocov start
	old_attr <- purrr::keep(attributes(x), names(attributes(x)) %in% c("dic_r2g", "dic_g2r", "experiment", "model", "class"))
 	x <- as.data.frame(x)
	old_attr <- c(old_attr, purrr::keep(attributes(y), names(attributes(y)) %in% c("dic_r2g", "dic_g2r", "experiment", "model", "class")))
 	old_attr <- purrr::keep(old_attr, duplicated(old_attr) == FALSE)
...
#' @param ... other arguments
#' @name tidyverse
mutate_.experiment <- function(.data, ...) {  # nocov start
	old_attr <- purrr::keep(attributes(.data), names(attributes(.data)) %in% c("dic_r2g", "dic_g2r", "experiment", "model", "class"))
 	.data <- as.data.frame(.data)
...
#' @param ... other arguments
#' @name tidyverse
select_.experiment <- function(.data, ...) {  # nocov start
	old_attr <- purrr::keep(attributes(.data), names(attributes(.data)) %in% c("dic_r2g", "dic_g2r", "experiment", "model", "class"))
 	.data <- as.data.frame(.data)
...
#' @param ... other arguments
#' @name tidyverse
slice_.experiment <- function(.data, ...) {  # nocov start
	old_attr <- purrr::keep(attributes(.data), names(attributes(.data)) %in% c("dic_r2g", "dic_g2r", "experiment", "model", "class"))
 	.data <- as.data.frame(.data)
...
#' @param ... other arguments
#' @name tidyverse
summarise_.experiment <- function(.data, ...) {  # nocov start
	old_attr <- purrr::keep(attributes(.data), names(attributes(.data)) %in% c("dic_r2g", "dic_g2r", "experiment", "model", "class"))
 	.data <- as.data.frame(.data)
...
#' @param ... other arguments
#' @name tidyverse
transmute_.experiment <- function(.data, ...) {  # nocov start
	old_attr <- purrr::keep(attributes(.data), names(attributes(.data)) %in% c("dic_r2g", "dic_g2r", "experiment", "model", "class"))
 	.data <- as.data.frame(.data)
...
#' @param ... other arguments
#' @name tidyverse
validate_grouped_df.experiment <- function(x, ...) {  # nocov start
	old_attr <- purrr::keep(attributes(x), names(attributes(x)) %in% c("dic_r2g", "dic_g2r", "experiment", "model", "class"))
 	x <- as.data.frame(x)
